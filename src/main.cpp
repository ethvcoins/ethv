...
const string strMessageMagic = "EthvCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(REWARD_BLOCK > nBestHeight){
        nSubsidy = (PREMINED_COIN / REWARD_BLOCK) * COIN;
    }
...
// pos will take the block reward if within the mining period
...
bool IsInitialBlockDownload()
{
    ...
    return (GetTime() - nLastUpdate < 15 &&
            pindexBest->GetBlockTime() < GetTime() - nStakeMinAge);
}
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ethvcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nNonce   = !fTestNet ? 2291142 : 28510;

        assert(block.hashMerkleRoot == uint256("0x93dd2ead69d91f5890d4538ec9d6be30a4558dee6cc4452661f4b862f707143d"));
...
unsigned char pchMessageStart[4] = { 0xa8, 0xc3, 0x2e, 0x01 };
